            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text"
                           name="firstName"
                           id="firstName"
                           value="{{ old('firstName', $athlete->firstName) }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text"
                           name="lastName"
                           id="lastName"
                           value="{{ old('lastName', $athlete->lastName) }}"
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <select name="gender"
                        ...
                        <option value="M" {{ old('gender', $athlete->gender) === 'M' ? 'selected' : '' }}>Männlich</option>
                        <option value="F" {{ old('gender', $athlete->gender) === 'F' ? 'selected' : '' }}>Weiblich</option>
                        <option value="X" {{ old('gender', $athlete->gender) === 'X' ? 'selected' : '' }}>X</option>
                    </select>
                    @error('gender')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="date"
                           name="birthdate"
                           id="birthdate"
                           value="{{ old('birthdate', optional($athlete->birthdate)->format('Y-m-d')) }}"
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text"
                           name="oebsv_license"
                           id="oebsv_license"
                           value="{{ old('oebsv_license', $athlete->license) }}"
                    ...
                    <select name="nation_id"
                        ...
                        @foreach($nations as $nation)
                            <option value="{{ $nation->id }}"
                                {{ (string) old('nation_id', $athlete->nation_id) === (string) $nation->id ? 'selected' : '' }}>
                    ...
                    <select name="para_club_id"
                        ...
                        @foreach($clubs as $club)
                            <option value="{{ $club->id }}"
                                {{ (string) old('para_club_id', $athlete->para_club_id) === (string) $club->id ? 'selected' : '' }}>
