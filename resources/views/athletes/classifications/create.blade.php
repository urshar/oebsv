                ...
                <div class="col-md-4 mb-3">
                    <div class="form-check mt-4">
                        <input type="checkbox"
                            ...
                            {{ old('is_international', false) ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text"
                           name="wps_license"
                           id="wps_license"
                           value="{{ old('wps_license', $athlete->license) }}"
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('sportclass_exception') }}"
